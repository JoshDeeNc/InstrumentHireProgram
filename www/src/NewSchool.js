                            ...
                            <div class="panel-content">
                                ...
                                <form class="needs-validation" novalidate>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="tel" pattern="[0-9]{0,12}" maxlength="12" class="form-control no-edit" name="code" id="newSchoolNumber" required />
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control no-edit" name="code" id="newSchoolEmail" required/>
