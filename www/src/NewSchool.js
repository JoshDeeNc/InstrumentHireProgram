                            ...
                            <div class="panel-content">
                                ...
                                <form>
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <Input type="text" class="form-control no-edit" name="name" id="newSchoolName" placeholder="First name" />
                                        </div>
                                        <div class="col-sm-12 ">
                                            <div class=" hr"></div>
                                        </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <Input type="text" class="form-control no-edit" name="code" id="newSchoolNumber" placeholder="Phone number" />
                                        </div>
                                        <div class="col-sm-12 ">
                                            <div class=" hr"></div>
                                        </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <Input type="text" class="form-control no-edit" name="code" id="newSchoolEmail" placeholder="Email" />
                                        </div>
                                        <div class="col-sm-12 ">
                                            <div class=" hr"></div>
                                        </div>
