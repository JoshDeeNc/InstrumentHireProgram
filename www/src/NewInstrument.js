                            ...
                            <div class="panel-content">
                                ...
                                <form>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <Input type="text" class="form-control" name="code" id="newInstCode" placeholder="code" />
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                ...
                                                <Input type="text" class="form-control" name="rate" id="newInstRate" placeholder="rate" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                ...
                                                <Input type="text" class="form-control" name="rate" id="newInstPurchVal" placeholder="cost" />
                                            </div>
                                        </div>
                                    </div>
