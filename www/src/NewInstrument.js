                            ...
                            <div class="panel-content">
                                ...
                                <form>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <Input type="text" class=" form-control no-edit" name="code" id="newInstCode" placeholder="Instrument code" />
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <Input type="text" class=" form-control no-edit" name="name" id="newInstType" placeholder="Instrument/Add-on Type" />
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <Input type="text" class=" form-control no-edit" name="name" id="newInstName" placeholder="Instrument/add-on" />
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <Input type="text" class=" form-control no-edit" name="brand" id="newInstBrand" placeholder="Brand" />
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                ...
                                                <Input type="text" class=" form-control no-edit" name="rate" id="newInstRate" placeholder=" " />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                ...
                                                <Input type="text" class=" form-control no-edit" name="rate" id="newInstPurchVal" placeholder=" " />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class=" form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="input-group">
                                                <Input type="text" class=" form-control no-edit" name="rate" id="newInstDepr" placeholder=" " />
