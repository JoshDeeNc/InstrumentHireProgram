...
function updateRecord(username, recordId, eventBody) {
    ...
    let params = {
        ...
        UpdateExpression: "set #field = :c, lastupdate_date = :lud, #szs = :szs, #ado = :ado",
...
// Lambda Handler
exports.updateInstOptions =
    metricScope(metrics =>
        async (event, context, callback) => {
            metrics.setNamespace('TodoApp')
            metrics.putDimensions({ Service: "updateInstOptions" })
